...
-- Update admin password to plain text format (matching other users)
UPDATE users 
SET password_hash = 'Admin123!'  -- Plain text password
WHERE user_id = 'admin-uuid-00000-00000-00000-000000000001';

delete  from resources  where resources_id = 17
