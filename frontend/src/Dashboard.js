...
export default function Dashboard() {
  ...
  const ServiceCard = ({ icon, title, text, active, onClick }) => (
    <div
      ...
      style={{
        ...
        minHeight: "190px",
        boxShadow: active
          ? "0 22px 45px rgba(114,96,180,0.25)"
          : "0 16px 35px rgba(17,17,17,0.05)",
      }}
    >
      <div
        style={{
      ...
      <p
        style={{
          ...
          fontSize: "13px",
          lineHeight: 1.7,
          color: active ? "#f4f2ff" : COLORS.muted,
        }}
      >
        {text}
      </p>
      <span style={{ fontSize: "13px", fontWeight: 900 }}>Open Now</span>
    </div>
  );
  ...
  const StudentView = () => (
    <div>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Request facilities, check your bookings, create maintenance
              tickets, and follow campus updates from one simple student
              dashboard.
            </p>
      ...
      >
        ...
        >
          <h2 style={{ margin: 0, fontSize: "30px", color: COLORS.black }}>
            Today's Student Overview
          </h2>
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            Keep your campus work organized. This dashboard helps you access
            booking, resource, and support services faster.
          </p>
        ...
        <div>
          <p
            style={{ color: COLORS.purple, fontWeight: 800, fontSize: "13px" }}
          >
          ...
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            Students can browse lecture halls, labs, meeting rooms, and
            equipment. They can request a booking with date, time, purpose, and
            expected attendees. They can also create incident tickets with
            priority and contact details.
          </p>
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            The system supports clear workflows, so every request has a visible
            status and users can follow progress without confusion.
          </p>
          <ActionButton filled onClick={() => navigate("/facilities")}>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "36px" }}>
          ...
          <h2
            style={{ margin: "8px 0 0", fontSize: "34px", color: COLORS.black }}
          >
    ...
    <div>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Manage lecture resources, review bookings, monitor classroom
              issues, and support smooth academic operations.
            </p>
          ...
          <div style={{ position: "relative", minHeight: "320px" }}>
            ...
            >
              <h3 style={{ margin: 0, fontSize: "22px", color: COLORS.black }}>
              ...
              >
                Access resource booking, lecture hall availability, maintenance
                reporting, and academic facility support.
              </p>
      ...
      >
        ...
        >
          ...
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            Use this dashboard to keep resource usage, class activities, and
            facility issues organized.
          </p>
        ...
        <div>
          ...
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            Lecturers can check available rooms and equipment, request bookings
            for academic activities, and report problems in classrooms, labs, or
            equipment.
          </p>
          <p style={{ color: COLORS.muted, lineHeight: 1.8 }}>
            This view is designed for quick access, so academic staff can
            complete common tasks without searching through multiple pages.
          </p>
          <ActionButton filled onClick={() => navigate("/facilities")}>
    ...
    <div style={{ display: "grid", gap: "18px" }}>
      ...
      >
        ...
        <p style={{ margin: 0, color: "#cbd5e1", maxWidth: "720px" }}>
          Track your assigned tickets, update progress, and record resolution
  ...
  if (!user) {
    return (
      <div
        style={{ color: COLORS.black, padding: "50px", textAlign: "center" }}
      >
        Loading...
      </div>
    );
    ...
    <div style={{ minHeight: '100vh', backgroundColor: COLORS.white, color: COLORS.black, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ padding: "0", width: "100%", margin: 0 }}>
        ...
        <div style={{ width: "100%" }}>
          ...
          {!["technician", "lecturer", "student"].includes(user.role) && (
            <StudentView />
          )}
        </div>
      </div>
      ...
      {profileOpen && (
        ...
        >
          {/* OUTER WRAPPER - Now transparent with a GAP */}
          <div
            style={{
              width: "min(980px, 100%)",
          ...
          >
            ...
            >
              ...
              />
              <ProfileTabButton
                active={profileTab === "edit"}
                onClick={() => selectProfileTab("edit")}
                label="Edit Profile"
              />
              <ProfileTabButton
                active={profileTab === "notifications"}
                onClick={() => selectProfileTab("notifications")}
                label="Notifications"
              />
              <ProfileTabButton
                active={profileTab === "account"}
                onClick={() => selectProfileTab("account")}
              ...
              {profileTab === "edit" && (
                ...
                >
                  ...
                  <Field
                    ...
                    onChange={(v) => handleProfileDraft("name", v)}
                  />
                  <Field
                    label="Email"
                    value={profileDraft.email}
                    onChange={(v) => handleProfileDraft("email", v)}
                  />
                  <Field
                    label="Student/Lecturer ID"
                    value={profileDraft.studentId}
                    onChange={(v) => handleProfileDraft("studentId", v)}
                  />
...
const ProfileTabButton = ({ active, onClick, label }) => (
  <button
    onClick={onClick}
    style={{
      width: "100%",
